...
public class WorkingUserAdapter  extends BaseAdapter {
    Context context;
    ArrayList<WorkingList> workingLists;

    public  WorkingUserAdapter(Context context,ArrayList<WorkingList> workingListArrayList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.e("sdsd",workingLists.get(position).getDivision());
